 ...
 *          (The 20th cycle occurs in the middle of the second addx -1, so the value of register X is the starting value,
 *          1, plus all of the other addx values up to that point: 1 + 15 - 11 + 6 - 3 + 5 - 1 - 8 + 13 + 4 = 21.)
 ...
 * of that sprite. (In this system, there is no such thing as "vertical position": if the sprite's
